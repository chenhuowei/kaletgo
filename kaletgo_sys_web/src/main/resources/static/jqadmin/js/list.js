    ...
    table.render({
        ...
        cols: [
            [
                ...
                { field: 'from', width: 200, sort: true, title: "来源" },
                { field: 'author', width: 80, title: "作者" },
                { field: 'cat_id', width: 80, title: "分类" },
                { field: 'order', width: 80, sort: true, title: "排序" },
                { toolbar: '#command', width: 60, title: "推荐" },
                { toolbar: '#switch', width: 60, title: "审核" },
                { align: 'center', toolbar: '#barDemo', width: 155, title: "操作" }
            ]
        ],
